...
/**
 * JPA mapping for the {@code outbox_events} table (the reliability core). Written in the
 * same transaction as the domain state change; drained by the outbox relay.
 */
@Entity
